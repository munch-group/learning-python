...
% % loads back to allow the komascript book class (scrbook) to work with titlesec:
...
% % \usepackage[]{titlesec}
% % \titleformat{\subsubsection}{\sffamily\normalsize\bfseries}{}{0em}{}[\thesubsubsection]
...
%   % Item \csname the#1\endcsname:{} %Well, could say Item \thesubsubsection:{} here as well... 
%   \currentname \vspace{1em} \thesubsubsection{}
%   \else
%   \@seccntformatorig{#1}%
%   \fi
% }
